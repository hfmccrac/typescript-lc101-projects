...
const getDaysToLocation = (kilometersAway:number):number => {
    const milesToDest:number = kilometersAway * milesPerKilometer;
    const hoursToDest:number = milesToDest * speedMph;
    const daysToDest:number = hoursToDest / 24;
    return daysToDest;
}
...
getDaysToLocation = (kilometersAway:number):number => {
    //console.log(this)
    const milesToDest:number = kilometersAway * this.milesPerKilometer;
    const hoursToDest:number = milesToDest * this.speedMph;
    const daysToDest:number = hoursToDest / 24;
    return daysToDest;
    }
