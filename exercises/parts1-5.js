...
var getDaysToLocation = function (kilometersAway) {
    var milesToDest = kilometersAway * milesPerKilometer;
    var hoursToDest = milesToDest * speedMph;
    var daysToDest = hoursToDest / 24;
    return daysToDest;
};
...
var SpaceCraft = /** @class */ (function () {
    function SpaceCraft(name, speedMph) {
        ...
        this.getDaysToLocation = function (kilometersAway) {
            //console.log(this)
            var milesToDest = kilometersAway * _this.milesPerKilometer;
            var hoursToDest = milesToDest * _this.speedMph;
            var daysToDest = hoursToDest / 24;
            return daysToDest;
        };
        this.name = name;
